...
export default function DashboardActionTilesMin() {
  return (
    <View className="p-4 pt-0 bg-gray-100">
      ...
      <View className="flex-row flex-wrap justify-between">
         {/* Add Payment Tile */}
        <TouchableOpacity className="bg-white rounded-xl shadow p-4 mb-4 w-[100%]"
            onPress={() => {
        ...
        >
          <View className="items-center">
            ...
            <Text className="text-sm font-medium text-gray-800">Create Payment</Text>
          </View>
        </TouchableOpacity>
